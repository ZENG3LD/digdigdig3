...
mod tests {
    ...
    fn testparse_price() {
        ...
        let price = PolygonParser::parse_price(&response).unwrap();
    ...
    fn test_parse_klines() {
        ...
        let klines = PolygonParser::parse_klines(&response).unwrap();
    ...
    fn test_parse_error() {
        ...
        let result = PolygonParser::extract_results(&response);
